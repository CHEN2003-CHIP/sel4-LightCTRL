...
LightDemo 的概要设计以 Microkit protection domain 为核心，通过集中 channel 契约和 shared memory layout 将控制链路组织成可解释的工程结构。系统既能演示正常车灯控制，也能演示 fault escalation、safe mode 和 recovery，是一个适合工程实践展示的嵌入式系统样例。
