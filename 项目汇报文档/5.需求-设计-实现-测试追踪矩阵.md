...
| REQ-LIGHT-005 | 状态查询输出 fault、vehicle、target 和统计信息。 | commandin 读取 shared memory 并输出 `STATUS_SNAPSHOT`。 | `commandin.c`, `light_status_snapshot.c` | `make test-snapshot`, `make test-serial-e2e` |
