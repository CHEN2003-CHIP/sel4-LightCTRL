...
light_vehicle_state_t light_vehicle_state_default(void) {
    ...
    vehicle_state.gear = LIGHT_VEHICLE_GEAR_DRIVE;
    vehicle_state.ambient_light = LIGHT_VEHICLE_AMBIENT_DAY;
    vehicle_state.hazard = 0;
    vehicle_state.drive_mode = LIGHT_VEHICLE_DRIVE_MODE_CITY;
